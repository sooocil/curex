    ...
    <div className="flex flex-col sm:flex-row gap-3">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-[200px]">
          ...
          <DropdownMenuSeparator />
          <DropdownMenuCheckboxItem checked>All Ratings</DropdownMenuCheckboxItem>
          <DropdownMenuCheckboxItem>4.5+</DropdownMenuCheckboxItem>
          <DropdownMenuCheckboxItem>4.0+</DropdownMenuCheckboxItem>
