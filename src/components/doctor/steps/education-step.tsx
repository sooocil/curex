              ...
              <Card key={index} className="overflow-hidden">
                <CardContent className="p-4">
                  <div className="grid gap-4 md:grid-cols-3">
                    <div>
                      <UILable htmlFor={`education.${index}.degree`}>
                        Degree
                      </UILable>
                      <Input
                    ...
                    <div>
                      <UILable htmlFor={`education.${index}.institution`}>
                        Institution
                      </UILable>
                      <Input
                    ...
                    <div>
                      <UILable htmlFor={`education.${index}.year`}>
                        Year
                      </UILable>
                      <Input
            ...
            {certifications.map((cert: any, index: number) => (
              <Card key={index} className="overflow-hidden">
                <CardContent className="p-4">
                  <div className="grid gap-4 md:grid-cols-3">
                    <div>
                      <UILable htmlFor={`certifications.${index}.name`}>
                        Certification
                      </UILable>
                      <Input
                    ...
                    <div>
                      <UILable htmlFor={`certifications.${index}.issuer`}>
                    ...
                    <div>
                      <UILable htmlFor={`certifications.${index}.year`}>
                        Year
                      </UILable>
                      <Input
